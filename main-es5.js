(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddressCardComponent = /** @class */ (function () {
                function AddressCardComponent(commonService) {
                    this.commonService = commonService;
                }
                AddressCardComponent.prototype.ngOnInit = function () { };
                // Deleting by calling the service delete method.
                AddressCardComponent.prototype.delete = function (index) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddressComponent = /** @class */ (function () {
                function AddressComponent(fb, commonSvc) {
                    this.fb = fb;
                ...
                AddressComponent.prototype.ngOnInit = function () {
                    ...
                    this.commonSvc.addrObs.subscribe(function (address) {
                        _this.addressForm.controls['pincode'].setValue(address.postalCode);
                        _this.addressForm.controls['locality'].setValue(address.locality);
                        _this.addressForm.controls['address'].setValue(address.formattedAddress);
                        _this.addressForm.controls['cdt'].setValue(address.city);
                        _this.addressForm.controls['state'].setValue(address.state);
                    });
                };
                ...
                AddressComponent.prototype.getLocation = function (e) {
                    var _this = this;
                    e.preventDefault();
                    if (navigator.geolocation) {
                        navigator.geolocation.getCurrentPosition(function (position) {
                            if (position) {
                                _this.commonSvc.setPosition(position.coords.latitude, position.coords.longitude);
                            }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MapComponent = /** @class */ (function () {
                function MapComponent(commonSvc) {
                    this.commonSvc = commonSvc;
                ...
                MapComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.commonSvc.coords.subscribe(function (val) {
                        _this.longitude = val.lng;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CommonService = /** @class */ (function () {
                ...
                function CommonService(http) {
                    ...
                    this.coords.subscribe(function (coord) { _this.setAddress(coord); });
                }
                // Handles change of coords 
                CommonService.prototype.setAddress = function (coord) {
                    var _this = this;
                    ...
                    this.http
                        ...
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res["results"][0]; }))
                        .subscribe(function (res) {
                        _this.address.formattedAddress = res["formatted_address"];
                        res.address_components.forEach(function (comp) {
                            if (comp.types.includes('country')) {
                                _this.address.country = comp["long_name"];
                            }
                            else if (comp.types.includes('postal_code')) {
                                _this.address.postalCode = comp["long_name"];
                            }
                            else if (comp.types.includes('administrative_area_level_1')) {
                                _this.address.state = comp["long_name"];
                            }
                            else if (comp.types.includes('administrative_area_level_2')) {
                                _this.address.city = comp["long_name"];
                            }
                            else if (comp.types.includes('neighborhood')) {
                                _this.address.locality = comp["long_name"];
                            }
                        });
                        console.log(_this.address);
                        _this.addrBS.next(_this.address);
                    });
                };
                // Sets the coords and fires the BehaviorSubject
                CommonService.prototype.setPosition = function (lat, lng) {
                    this.position.next({ lat: lat, lng: lng });
                };
                // Adds new address to the list
                CommonService.prototype.addAddress = function (address) {
                    this.addressList.push(address);
                    this.showForm = false;
                };
                // Removes the addresses from the list
                CommonService.prototype.deleteAddress = function (i) {
                    this.addressList = this.addressList.filter(function (address, index) {
                        return i !== index;
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var environment = {
                ...
                api: {
                    googleLocationAPI: function (lat, lng) {
